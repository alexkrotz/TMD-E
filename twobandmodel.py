...
def two_band_noCurve(q, tau, spin, params):
	(E_g, lambda_c, lambda_v, t) = params
...
def two_band(q, tau, spin, params):
	(E_g, lambda_c, lambda_v, t) = params
	E_val = -0.5 * E_g + 0.5 * tau * lambda_v * spin
	E_con = 0.5 * E_g + 0.5 * tau * lambda_c * spin
	E_split = E_con - E_val
...
def two_band_noCurve_new(q, tau, spin, params):
	(E_g, lambda_c, lambda_v, t) = params
	e1 = -0.5 * E_g
	e2 = 0.5 * E_g
	de = e2 - e1
...
def two_band_noCurve_noBerry(q, tau, spin, params):
	(E_g, lambda_c, lambda_v, t) = params
	e1 = -0.5 * E_g
	e2 = 0.5 * E_g
	de = e2 - e1
