class material:
    def __init__(self,lattice_const, lambda_c, lambda_v, w, g_e_DP0):
...
MoS2 = material( lattice_const=3.193/0.5292, lambda_c=-3.0e-3, lambda_v=148e-3, w=2.004, g_e_DP0=3.732)
MoSe2 = material(lattice_const=3.313/0.5292, lambda_c=-31.0e-3, lambda_v = 184e-3, w=1.3598, g_e_DP0=3.189)
WS2 = material(lattice_const=3.197/0.5292, lambda_c=26.0e-3, lambda_v=430e-3, w=1.85355, g_e_DP0=1.648)
WSe2 = material(lattice_const=3.310/0.5292, lambda_c=36.0e-3, lambda_v=466e-3, w=1.2159, g_e_DP0=1.285)
